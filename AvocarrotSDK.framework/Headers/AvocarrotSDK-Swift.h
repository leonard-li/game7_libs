...
- (NSString * _Nonnull)getRedirectionUrl SWIFT_WARN_UNUSED_RESULT;
...
- (NSString * _Nonnull)getCTAText SWIFT_WARN_UNUSED_RESULT;
///
/// returns:
/// the destination url
- (NSString * _Nonnull)getDestinationUrl SWIFT_WARN_UNUSED_RESULT;
///
/// returns:
/// the title
...
- (double)getRating SWIFT_WARN_UNUSED_RESULT;
///
/// returns:
...
- (NSString * _Nonnull)getIcon SWIFT_WARN_UNUSED_RESULT;
///
/// returns:
/// the adchoices model if the ad has one
- (AdChoices * _Nullable)getAdChoices SWIFT_WARN_UNUSED_RESULT;
- (void)encodeWithCoder:(NSCoder * _Nonnull)aCoder;
- (nonnull instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithJsonObject:(NSDictionary<NSString *, id> * _Nonnull)jsonObject requestId:(NSString * _Nullable)requestId OBJC_DESIGNATED_INITIALIZER;
@end
...
- (UIImageView * _Nullable)getAdChoicesImageView SWIFT_WARN_UNUSED_RESULT;
...
- (UINib * _Nullable)nibForAd SWIFT_WARN_UNUSED_RESULT;
@end
...
///
- (AvocarrotCustom * _Nonnull)onAdLoaded:(void (^ _Nonnull)(NSArray<AdModel *> * _Nonnull))adloaded SWIFT_WARN_UNUSED_RESULT;
/// Register callback to be called on ad error
/// \param adError a function with void return type and an AdError as parameter
///
- (AvocarrotCustom * _Nonnull)onAdError:(void (^ _Nonnull)(AdError * _Nonnull))adError SWIFT_WARN_UNUSED_RESULT;
...
///
- (AvocarrotCustom * _Nonnull)onAdViewClicked:(void (^ _Nonnull)(UIView * _Nonnull))adViewClicked SWIFT_WARN_UNUSED_RESULT;
...
///
- (AvocarrotCustom * _Nonnull)onAdClickRegistered:(void (^ _Nonnull)(void))adClickRegistered SWIFT_WARN_UNUSED_RESULT;
...
///
- (AvocarrotCustom * _Nonnull)onAdChoicesClicked:(void (^ _Nonnull)(UIView * _Nonnull))adChoicesClicked SWIFT_WARN_UNUSED_RESULT;
/// Register callback to be called on ad impression
/// \param adImpresion a function with void return type
///
- (AvocarrotCustom * _Nonnull)onAdImpression:(void (^ _Nonnull)(void))adImpresion SWIFT_WARN_UNUSED_RESULT;
/// Register callback to be called when the webview closes
/// \param adWebViewClosed a function with void return type
///
- (AvocarrotCustom * _Nonnull)onAdWebViewClosed:(void (^ _Nonnull)(void))adWebViewClosed SWIFT_WARN_UNUSED_RESULT;
/// Adds targeting data to ad request
/// \param targetModel a TargetModel instance
///
- (AvocarrotCustom * _Nonnull)withTargetingData:(TargetModel * _Nonnull)targetModel SWIFT_WARN_UNUSED_RESULT;
/// Switch between sandbox and live mode
- (AvocarrotCustom * _Nonnull)withSandbox:(BOOL)sandbox SWIFT_WARN_UNUSED_RESULT;
/// Set User logging level
/// \param enableLogging true to enable logging
///
/// \param logLevel the LogLevel of the logger
///
- (AvocarrotCustom * _Nonnull)withLogging:(BOOL)enableLogging logLevel:(enum LogLevel)logLevel SWIFT_WARN_UNUSED_RESULT;
/// Loads the ad
/// <ul>
///   <li>
...
- (nonnull instancetype)initWithApiKey:(NSString * _Nonnull)apiKey placementKey:(NSString * _Nonnull)placementKey mediationType:(enum MediationType)mediationType OBJC_DESIGNATED_INITIALIZER;
- (AvocarrotInstream * _Nonnull)withRenderingClass:(Class _Nonnull)renderingClass SWIFT_WARN_UNUSED_RESULT;
- (AvocarrotInstream * _Nonnull)withFrequency:(NSInteger)adStart adFrequency:(NSInteger)adFrequency SWIFT_WARN_UNUSED_RESULT;
/// Adds targeting data to ad request
/// \param targetModel a TargetModel instance
///
- (AvocarrotInstream * _Nonnull)withTargetingData:(TargetModel * _Nonnull)targetModel SWIFT_WARN_UNUSED_RESULT;
- (AvocarrotInstream * _Nonnull)withSandbox:(BOOL)sandbox SWIFT_WARN_UNUSED_RESULT;
- (AvocarrotInstream * _Nonnull)withLogging:(BOOL)enable level:(enum LogLevel)level SWIFT_WARN_UNUSED_RESULT;
/// Register callback to be called when ad is loaded
/// \param adloaded a function with void return type and a AdModel as parameter
///
- (AvocarrotInstream * _Nonnull)onAdLoaded:(void (^ _Nonnull)(NSArray<AdModel *> * _Nonnull))adloaded SWIFT_WARN_UNUSED_RESULT;
/// Register callback to be called on ad error
/// \param adError a function with void return type and an AdError as parameter
///
- (AvocarrotInstream * _Nonnull)onAdError:(void (^ _Nonnull)(AdError * _Nonnull))adError SWIFT_WARN_UNUSED_RESULT;
/// Register callback to be called when the ad view is clicked
/// \param adViewClicked a function with void return type and an UIView as parameter
///
- (AvocarrotInstream * _Nonnull)onAdViewClicked:(void (^ _Nonnull)(UIView * _Nonnull))adViewClicked SWIFT_WARN_UNUSED_RESULT;
/// Register callback to be called when the ad click is registered and tracked
/// \param adClickRegistered a function with void return type
///
- (AvocarrotInstream * _Nonnull)onAdClickRegistered:(void (^ _Nonnull)(void))adClickRegistered SWIFT_WARN_UNUSED_RESULT;
/// Register callback to be called when the adChoices view is clicked
/// \param adChoicesClicked a function with void return type and an UIView as parameter
///
- (AvocarrotInstream * _Nonnull)onAdChoicesClicked:(void (^ _Nonnull)(UIView * _Nonnull))adChoicesClicked SWIFT_WARN_UNUSED_RESULT;
/// Register callback to be called on ad impression
/// \param adImpresion a function with void return type
///
- (AvocarrotInstream * _Nonnull)onAdImpression:(void (^ _Nonnull)(void))adImpresion SWIFT_WARN_UNUSED_RESULT;
/// Register callback to be called when the webview closes
/// \param adWebViewClosed a function with void return type
///
- (AvocarrotInstream * _Nonnull)onAdWebViewClosed:(void (^ _Nonnull)(void))adWebViewClosed SWIFT_WARN_UNUSED_RESULT;
- (NSIndexPath * _Nonnull)normalizeToAdIndexPath:(NSIndexPath * _Nonnull)originalIndexPath SWIFT_WARN_UNUSED_RESULT;
- (NSArray<NSIndexPath *> * _Nonnull)normalizeToAdIndexPaths:(NSArray<NSIndexPath *> * _Nonnull)originalIndexPaths SWIFT_WARN_UNUSED_RESULT;
- (NSIndexPath * _Nonnull)normalizeToOriginalIndexPath:(NSIndexPath * _Nonnull)adIndexPath SWIFT_WARN_UNUSED_RESULT;
- (NSArray<NSIndexPath *> * _Nonnull)normalizeToOriginalIndexPaths:(NSArray<NSIndexPath *> * _Nonnull)adIndexPaths SWIFT_WARN_UNUSED_RESULT;
...
/// \param adloaded a function with void return type and a AdModel as parameter
///
- (AvocarrotInterstitial * _Nonnull)onAdLoaded:(void (^ _Nonnull)(NSArray<AdModel *> * _Nonnull))adloaded SWIFT_WARN_UNUSED_RESULT;
/// Register callback to be called on ad error
/// \param adError a function with void return type and an AdError as parameter
///
- (AvocarrotInterstitial * _Nonnull)onAdError:(void (^ _Nonnull)(AdError * _Nonnull))adError SWIFT_WARN_UNUSED_RESULT;
/// Register callback to be called when the ad view is clicked
/// \param adViewClicked a function with void return type and an UIView as parameter
///
- (AvocarrotInterstitial * _Nonnull)onAdViewClicked:(void (^ _Nonnull)(UIView * _Nonnull))adViewClicked SWIFT_WARN_UNUSED_RESULT;
/// Register callback to be called when the ad click is registered and tracked
/// \param adClickRegistered a function with void return type
///
- (AvocarrotInterstitial * _Nonnull)onAdClickRegistered:(void (^ _Nonnull)(void))adClickRegistered SWIFT_WARN_UNUSED_RESULT;
/// Register callback to be called when the adChoices view is clicked
/// \param adChoicesClicked a function with void return type and an UIView as parameter
///
- (AvocarrotInterstitial * _Nonnull)onAdChoicesClicked:(void (^ _Nonnull)(UIView * _Nonnull))adChoicesClicked SWIFT_WARN_UNUSED_RESULT;
/// Register callback to be called on ad impression
/// \param adImpresion a function with void return type
///
- (AvocarrotInterstitial * _Nonnull)onAdImpression:(void (^ _Nonnull)(void))adImpresion SWIFT_WARN_UNUSED_RESULT;
/// Register callback to be called when the webview closes
/// \param adWebViewClosed a function with void return type
///
- (AvocarrotInterstitial * _Nonnull)onAdWebViewClosed:(void (^ _Nonnull)(void))adWebViewClosed SWIFT_WARN_UNUSED_RESULT;
...
///
- (AvocarrotInterstitial * _Nonnull)onAdDisplayed:(void (^ _Nonnull)(void))adDisplayed SWIFT_WARN_UNUSED_RESULT;
/// Register callback to be called when the interstitial closes
/// \param adDisplayed a function with void return type
///
- (AvocarrotInterstitial * _Nonnull)onAdDismissed:(void (^ _Nonnull)(void))adDismissed SWIFT_WARN_UNUSED_RESULT;
/// Adds targeting data to ad request
/// \param targetModel a TargetModel instance
///
- (AvocarrotInterstitial * _Nonnull)withTargetingData:(TargetModel * _Nonnull)targetModel SWIFT_WARN_UNUSED_RESULT;
/// Switch between sandbox and live mode
- (AvocarrotInterstitial * _Nonnull)withSandbox:(BOOL)sandbox SWIFT_WARN_UNUSED_RESULT;
/// Set User logging level
/// \param enableLogging true to enable logging
///
/// \param logLevel the LogLevel of the logger
///
- (AvocarrotInterstitial * _Nonnull)withLogging:(BOOL)enableLogging logLevel:(enum LogLevel)logLevel SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end
...
- (UIViewContentMode)getContentMode SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end
...
- (UIEdgeInsets)getInsets SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end
...
- (TargetModelBuilder * _Nonnull)withYearOfBirth:(NSInteger)yearOfBirth SWIFT_WARN_UNUSED_RESULT;
/// Sets the gender to the target model
- (TargetModelBuilder * _Nonnull)withGender:(enum Gender)gender SWIFT_WARN_UNUSED_RESULT;
/// Sets the age to the target model
- (TargetModelBuilder * _Nonnull)withAge:(NSInteger)age SWIFT_WARN_UNUSED_RESULT;
/// Builds the TargetModel
/// Returns: a TargetModel object
- (TargetModel * _Nonnull)build SWIFT_WARN_UNUSED_RESULT;
...
- (NSTextAlignment)getAlignment SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end
...
- (void)av_reloadData;
- (CGRect)av_rectForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
- (NSIndexPath * _Nonnull)av_indexPathForRowAtPoint:(CGPoint)point SWIFT_WARN_UNUSED_RESULT;
- (NSIndexPath * _Nullable)av_indexPathForCell:(UITableViewCell * _Nonnull)cell SWIFT_WARN_UNUSED_RESULT;
- (NSArray<NSIndexPath *> * _Nullable)av_indexPathsForRowsInRect:(CGRect)rect SWIFT_WARN_UNUSED_RESULT;
- (UITableViewCell * _Nullable)av_cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
...
- (UITableViewCell * _Nonnull)av_dequeueReusableCellWithIdentifier:(NSString * _Nonnull)identifier forIndexPath:(NSIndexPath * _Nonnull)forIndexPath SWIFT_WARN_UNUSED_RESULT;
@end
